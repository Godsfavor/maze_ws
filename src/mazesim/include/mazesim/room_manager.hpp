...
public:
    RoomManager() {
        ...
        rooms_["room_1"] = {4.06, 14.85, 0.0, 1.57};    // Upper-left (was Room 2)
        rooms_["room_2"] = {15.56, 14.85, 0.0, 3.14};   // Upper-right (was Room 3)
        rooms_["room_3"] = {4.06, 3.85, 0.0, 0.0};      // Lower-left (was Room 0)
        rooms_["room_4"] = {15.56, 6.35, 0.0, -1.57};   // Lower-right (was Room 1)

...
public:
    RoomManager() {
        ...
        paths_["room_4_room_3"] = { {-0.2, 0.8}, {-0.35, 0.7}, {-0.35, 1.27}, {-0.8, 1.3}, {-0.8, 0.4}, {-0.7, 0.6}, {-1.4, 0.6}, {-1.47, 1.0}, {-1.4, 1.2} };

        paths_["room_3_room_2"] = { {-1.4, 1.20}, {-1.4, 1.00}, {-1.3, 0.4}, {-0.5, 0.6}, {-0.5, -0.4}, {-0.8, -0.4}, {-1.2, -0.46} };

...
public:
    RoomManager() {
        ...
        paths_["room_3_room_4"] = { {-1.4, 0.8}, {-1.3, 0.4}, {-0.7, 0.6}, {-0.5, 0.6}, {-0.6, 1.3}, {-0.1, 1.26}, {-0.25, 0.7} };
        ...
        // Counter-clockwise (left) transitions
        paths_["room_1_room_4"] = { {-0.2, -0.12}, {-.45, -0.2}, {-0.5, -0.2}, {-0.7, 0.0}, {-0.7, 0.25}, {-0.7, 0.5}, {0.4, 0.36}, {0.46, 0.4}, {0.24, 1.34}, {-0.2, 1.33}, {-0.5, 1.21}, {-0.35, 0.8} };

        paths_["room_4_room_3"] = { {-0.2, 0.8}, {-0.35, 0.7}, {-0.35, 1.27}, {-0.8, 1.30}, {-0.8, 0.4}, {-0.7, 0.6}, {-1.4, 0.6}, {-1.46, 1.0}, {-1.4, 1.2} };

        paths_["room_3_room_2"] = { {-1.4, 1.20}, {-1.36, 1.00}, {-1.3, 0.4}, {-0.5, 0.6}, {-0.5, -0.4}, {-0.8, -0.4}, {-1.2, -0.46} };

        paths_["room_2_room_1"] = { {-1.3, -0.4}, {-0.8, -0.5}, {-0.4, -0.37}, {-0.48, 0.1}, {0.0, -0.1} };
    }

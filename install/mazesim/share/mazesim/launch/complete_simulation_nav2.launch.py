...
def generate_launch_description():
    ...
    for i, robot in enumerate(robots):
        ...
        # Robot state publisher - publishes robot's internal TF tree
        ...
        # Odometry TF broadcaster - publishes odom->base_footprint transform
        # NO NAMESPACE - publishes to global /tf so Nav2 can see it
        odom_tf_broadcaster = Node(
            ...
            remappings=[
                ('odom', f'/{robot_name}/odom'),  # Subscribe to /robot1/odom instead of /odom
            ],
            output='screen'
        )
        ...
        # Command translator for this robot
        translator = Node(
            package='mazesim',
        ...
        launch_list.extend([
            ...
            TimerAction(period=base_delay + 1.5, actions=[odom_tf_broadcaster]),
